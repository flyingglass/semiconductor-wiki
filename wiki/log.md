...
## [2026-06-16] ingest | 穷查理宝典第二章：芒格的生活、学习和决策方法

从 IMA 知识库获取《穷查理宝典：查理·芒格智慧箴言录》PDF，深读第二章全文（约20,000字），完成：
- 保存完整原文到 raw/articles/（穷查理宝典_第二章）
- 创建 papers/ 摘要页：考夫曼_2005_芒格的生活学习和决策方法
- 创建 concepts/ 概念页：芒格思维框架（连接半导体产业分析）
- 更新 index.md 和 log.md
- 核心概念提取：多元思维模型、双轨分析、能力圈、逆向思维、Lollapalooza效应、投资原则检查清单（十大原则）、护城河理论、安全边际、诚实即策略
- 半导体关联：生态系统思维→产业链分析、竞争性毁灭→技术迭代风险、安全边际→供应链冗余、Lollapalooza→AI半导体浪潮
